   ...
   <div className="header">
      ...
      <Container className="mb-3">
         <Row>
            ...
            <h2 className="white-heading custm_h2">Agent Login</h2>
            <div className="login-form custm_Login2">
               <FormGroup>
                  ...
                  */}
                  <a className="forgot" onClick={handleShow}>
                     <p>Forgot Password?</p>
                  </a>
                  ...
                  <Button type="button" onClick={handleSubmit(onSubmit)}  className="login-bt cust_Agentbutton">
                  Login
                  </Button>
                  </Col>
               </FormGroup>
