...
import { USER_URL, LANDLORD_URL,ROOM_URL } from '../../../shared/allApiUrl';
...
const Roompic = (props) => {
  ...
  const roomImageViewApi = async () => {
    let { data } = await axiosApiCall.get(`${ROOM_URL}/${props.userId}`, null);
    console.log("data===",data)
    setRoomDetails(data.data)
    setImageUploadCheck(false)
  }
  console.log("props.userId",props.userId,roomDetails);
